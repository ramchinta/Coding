...
copy_command = "copy clickstream.clickhits_1 from 's3://axlpoc2/site_hits_test.gz' iam_role 'arn:aws:iam::374091793621:role/redshift_to_s3_role' delimiter '\t' acceptanydate dateformat 'auto'  NULL AS 'NULL' EMPTYASNULL ESCAPE ACCEPTINVCHARS COMPUPDATE OFF STATUPDATE OFF gzip;"
#copy_command = 'select * from clickstream.clickhits_1'
cur = con.cursor()
